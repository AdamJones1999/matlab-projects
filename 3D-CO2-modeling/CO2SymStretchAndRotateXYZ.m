function CO2SymStretchAndRotateXYZ()
    ...
    for k = 1:length(t)
        ...
        if (n == 1)
            ...
            O1 = RotateX3D(O1, theta(k));
            O2 = RotateX3D(O2, theta(k));
        elseif (n == 2)
            O1 = Translate3D(O1_0, sin(theta(k))*x(k), 0, cos(theta(k))*x(k));
            O2 = Translate3D(O2_0, -sin(theta(k))*x(k), 0, -cos(theta(k))*x(k));
            
            C = RotateY3D(C_0, theta(k));
            O1 = RotateY3D(O1, theta(k));
            O2 = RotateY3D(O2, theta(k));
        elseif (n == 3)
            O1 = Translate3D(O1_0, x(k), 0, 0);
            O2 = Translate3D(O2_0, -x(k), 0, 0);
            
            C = RotateZ3D(C_0, theta(k));
            O1 = RotateZ3D(O1, theta(k));
            O2 = RotateZ3D(O2, theta(k));
        end
